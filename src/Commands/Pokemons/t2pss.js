module.exports = {
    ...
    category: 'pokemon',
    usage: 'Use :t2pss 1',
    description: 'Transfer a Pokemon from your party to your PC (PSS)',
    async execute(client, arg, M) {
        ...
        if (!idx || idx < 1) {
            return M.reply(`Use *${client.prefix}t2pss 1*`)
        }
        ...
        return M.reply(`Transferred *${client.utils.capitalize(pokemon.name)}* to your PC. Party: ${party.length}/6, PC: ${pss.length}.`)
    }
}
